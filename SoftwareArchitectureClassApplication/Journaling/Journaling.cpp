...
JournalCallParamDataInt::JournalCallParamDataInt(std::string paramName,
    ...
    JournalCallParamData(
        paramName, paramType, JournalCallParamData::ParameterBasicType::INTEGER), m_value(value)
{
...
JournalCallParamDataBoolean::JournalCallParamDataBoolean(std::string paramName,
    ...
    JournalCallParamData(
        paramName, paramType, JournalCallParamData::ParameterBasicType::BOOLEAN), m_value(value)
{
