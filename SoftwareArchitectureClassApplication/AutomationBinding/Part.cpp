...
AutomationAPI::PartImpl::PartImpl(int guid)
{
	...
	m_manageCollection = new ManageCollection(m_guid);
...
AutomationAPI::ManageCollection* AutomationAPI::PartImpl::Features()
{
	return m_manageCollection;
}

AutomationAPI::ManageCollection* AutomationAPI::Part::Features()
{
	return m_partImpl->Features();
}
